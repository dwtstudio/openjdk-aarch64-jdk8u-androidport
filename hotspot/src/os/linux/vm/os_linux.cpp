...
# include <fcntl.h>
# include <string.h>
//# include <syscall.h> // --android-patch
# include <sys/syscall.h> // --android-patch
# include <sys/sysinfo.h>
//# include <gnu/libc-version.h> // --android-patch
# include <sys/ipc.h>
//# include <sys/shm.h> // --android-patch
# include <link.h>
# include <stdint.h>
# include <inttypes.h>
# include <sys/ioctl.h>
...
// --android-patch-start : NDK toolchain , defined it myself.
/*
...
os::Linux::set_glibc_version("glibc 2.x 2.x");//--android-patch
os::Linux::set_libpthread_version("NPTL"); //--android-patch
...
bool os::dll_address_to_library_name(address addr, char* buf,
  ...
  data.buflen = buflen;
  data.base = NULL;
  int rslt = 0; //dl_iterate_phdr(address_to_library_name_callback, (void *)&data); //--android-patch
...
//--android-patch : We don't need to defined all architectures.
  static const arch_t arch_array[]={
    {EM_386,         EM_386,     ELFCLASS32, ELFDATA2LSB, (char*)"IA 32"},
    {EM_486,         EM_386,     ELFCLASS32, ELFDATA2LSB, (char*)"IA 32"},
    //{EM_IA_64,       EM_IA_64,   ELFCLASS64, ELFDATA2LSB, (char*)"IA 64"}, //--android-patch
    //{EM_X86_64,      EM_X86_64,  ELFCLASS64, ELFDATA2LSB, (char*)"AMD 64"}, //--android-patch
...
//--android-patch-end
    ...
    //{EM_S390,        EM_S390,    ELFCLASSNONE, ELFDATA2MSB, (char*)"IBM System/390"}, //--android-patch
    {EM_ALPHA,       EM_ALPHA,   ELFCLASS64, ELFDATA2LSB, (char*)"Alpha"},
    //{EM_MIPS_RS3_LE, EM_MIPS_RS3_LE, ELFCLASS32, ELFDATA2LSB, (char*)"MIPSel"}, //--android-patch
...
void os::jvm_path(char *buf, jint buflen) {
  ...
  if (ret && dli_fname[0] != '\0') {
    ...
    if(access(rp, F_OK) !=0){
        ...
        assert(java_home_var != NULL, "cannot find directory for alls");
...
//--android-patch-start : shm* are not available
/*
#ifndef SHM_HUGETLB
...
//--android-patch-start : No cpu_set_t available for Android
/*
...
int os::open(const char *path, int oflag, int mode) {
  ...
  fd = ::open64(path, oflag, mode); //--android-patch
  if (fd == -1) return -1;
...
int os::create_binary_file(const char* path, bool rewrite_existing) {
  ...
  if (!rewrite_existing) {
    ...
    //return ::open64(path, oflags, S_IREAD | S_IWRITE); //--android-patch
    return ::open64(path, oflags, 00400 | 00200);
}
...
int os::loadavg(double loadavg[], int nelem) {
    // --android-patch
    //load average cannot be obtained
