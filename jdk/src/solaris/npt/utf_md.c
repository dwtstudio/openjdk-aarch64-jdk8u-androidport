...
//--android-patch-start : No iconv_open available in Android
/*
...
{
//--android-patch-start : No iconv_close available in Android
/*
    if ( ui->iconvFromPlatform != (void *)-1 ) {
...
//--android-patch-start : No iconv available in Android
/*
